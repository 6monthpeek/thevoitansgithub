        ...
        async function primeRoles() {
            try {
                ...
                if (!alive)
                    return;
                if (typeof window !== "undefined") {
                    window.__ROLE_NAME_CACHE__ = { roles: payload?.roles ?? {} };
                }
...
function WeeklySchedule() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "mt-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsx)("div", { className: "text-sm text-zinc-400", children: data && data.week ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: ["Hafta:", " ", new Date(data.week.start).toLocaleDateString("tr-TR", {
                    ...
                    return ((0, jsx_runtime_1.jsxs)("div", { className: "rounded-xl border border-white/10 bg-black/40 p-3 backdrop-blur", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between", children: [(0, jsx_runtime_1.jsx)("div", { className: "text-xs uppercase tracking-wide text-zinc-400", children: fmtDay(d) }), isToday && ((0, jsx_runtime_1.jsx)("span", { className: "text-[10px] px-2 py-0.5 rounded-full border border-white/10 bg-white/5 text-zinc-300", children: "Bug\u00FCn" }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-2 space-y-2", children: [(eventsByDay[key] ?? []).length === 0 && ((0, jsx_runtime_1.jsx)("div", { className: "text-xs text-zinc-500", children: "Etkinlik yok" })), (eventsByDay[key] ?? []).map((ev) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        const run = async () => {
            ...
            try {
                ...
                if (!r.ok) {
                    setMembers([]);
                    setMeta((m) => ({ ...m, loading: false, totalPages: 1, error: j?.error || "Üyeler yüklenemedi" }));
                }
                else {
...
function OfficerAnnounce() {
    ...
    const roles = raw.map((r) => ({ id: String(r?.id ?? r), name: r?.name }));
...
function OfficerPanel() {
    const { data: session } = (0, react_2.useSession)();
    const isSeniorOfficer = (session?.user?.guildMember?.roles ?? []).some((r) => r?.name?.toLowerCase() === "senior officer");
