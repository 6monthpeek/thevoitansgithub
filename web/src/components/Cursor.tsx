...
export default function Cursor() {
  useEffect(() => {
    ...
    // -----------------------------------------------------------------
    let cursor = document.querySelector('.v-cursor') as HTMLDivElement | null;
    ...
    const onScroll = () => {
      ...
      const progress = document.querySelector('.v-scroll-line__progress') as HTMLDivElement | null;
    ...
    // -----------------------------------------------------------------
    const hoverIn = () => {
      const inner = cursor?.querySelector('.v-cursor__inner') as HTMLDivElement | null;
      const link = cursor?.querySelector('.v-cursor__link-315') as HTMLDivElement | null;
      if (inner) {
        inner.style.width = '0';
