...
const g = globalThis;
const cache = (_a = g.__voitansIcsCache) !== null && _a !== void 0 ? _a : new Map();
...
function toIsoZ(dtLine) {
    ...
    const value = (_a = parts.pop()) !== null && _a !== void 0 ? _a : "";
...
function GET(req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const weekOffset = Number((_a = searchParams.get("weekOffset")) !== null && _a !== void 0 ? _a : "0");
            ...
            if (!txt) {
                ...
                while (attempt < maxAttempts) {
                    attempt++;
                    try {
                        const res = yield fetch(ICS_URL, { headers: { "cache-control": "no-cache" }, cache: "no-store", next: { revalidate: 0 } });
                        if (res.status === 429) {
                            const retryAfter = Number(res.headers.get("retry-after")) || attempt * 0.5;
                            const jitter = Math.random() * 0.2; // 0-200ms jitter
                            yield new Promise((r) => setTimeout(r, (retryAfter + jitter) * 1000));
                            continue;
                        }
                        if (!res.ok)
                ...
                if (!txt)
                    throw lastErr !== null && lastErr !== void 0 ? lastErr : new Error("ICS fetch failed");
            }
            ...
            const mapped = raw.map((e) => {
                ...
                const s = toIsoZ((_a = e.dtstart) !== null && _a !== void 0 ? _a : "");
                let en = toIsoZ((_b = e.dtend) !== null && _b !== void 0 ? _b : "");
                ...
                if (!s || !en)
                    return null;
                return {
                    id: (_c = e.uid) !== null && _c !== void 0 ? _c : `${e.summary}-${e.dtstart}`,
                    title: (_d = e.summary) !== null && _d !== void 0 ? _d : "Etkinlik",
                    description: (_e = e.description) !== null && _e !== void 0 ? _e : "",
                    location: (_f = e.location) !== null && _f !== void 0 ? _f : "",
                    start: s,
                    end: en,
                    allDay: !!e.allDay,
                };
            ...
            return server_1.NextResponse.json({ error: (_b = e === null || e === void 0 ? void 0 : e.message) !== null && _b !== void 0 ? _b : "unknown-error", events: [] }, { status: 500 });
        }
    });
}
