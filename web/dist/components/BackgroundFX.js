...
function BackgroundFX() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        function handleMove(e) {
            ...
            if (!targetEl)
                return;
            const parent = targetEl.parentElement; // main'in child'ı
            if (!parent)
                return;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: rootRef, className: "tv-bgfx pointer-events-none absolute inset-0 overflow-hidden", "aria-hidden": true, children: [(0, jsx_runtime_1.jsx)("div", { className: "tv-noise" }), (0, jsx_runtime_1.jsx)("div", { className: "tv-glow tv-glow--cyan" }), (0, jsx_runtime_1.jsx)("div", { className: "tv-glow tv-glow--amber" }), (0, jsx_runtime_1.jsx)("div", { className: "tv-glow tv-glow--violet" }), (0, jsx_runtime_1.jsx)("div", { className: "tv-grid" }), (0, jsx_runtime_1.jsx)("style", { jsx: true, children: `
        .tv-bgfx {
